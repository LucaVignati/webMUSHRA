...
function SPLATPage(_pageManager, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _mushraValidator, _errorHandler, _language) {
	this.isMushra = true; 
...
SPLATPage.prototype.getName = function () {
  return this.pageConfig.name;
};

SPLATPage.prototype.init = function () {
   var toDisable;
  var td;
  var active; 
...
SPLATPage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  var content; 
  ...
  var tdConditionNamesReference = $("<td>" + this.pageManager.getLocalizer().getFragment(this.language, 'void') + "</td>");
...
SPLATPage.prototype.pause = function() {
    this.mushraAudioControl.pause();
};

SPLATPage.prototype.setLoopStart = function() {
...
SPLATPage.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider'); 
...
SPLATPage.prototype.btnCallbackReference = function() {
...
SPLATPage.prototype.surpressLoop = function() {
...
SPLATPage.prototype.btnCallbackCondition = function(_index) {
...
SPLATPage.prototype.renderCanvas = function(_parentId) {
  ...
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'very much'),xLetters , prevScalesHeight * 0.1 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'much'), xLetters, prevScalesHeight * 0.3 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'a bit'), xLetters, prevScalesHeight * 0.5 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'barely'), xLetters, prevScalesHeight * 0.7 + YfirstLine);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'not at all'), xLetters, prevScalesHeight * 0.9 + YfirstLine);
...
SPLATPage.prototype.load = function () {
...
SPLATPage.prototype.save = function () {
  this.macic.unbind(); 
...
SPLATPage.prototype.store = function () {
